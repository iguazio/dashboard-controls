    ...
    function ValidationService($i18next, i18next, lodash) {
        ...
        var validationRules = {
            ...
            service: {
                ...
                resources: [generateRule.validCharacters('a-z A-Z 0-9 - _ .'), generateRule.beginNotWith('.'), generateRule.length({ max: lengths.service.resources })],
                persistentVolumeClaims: {
