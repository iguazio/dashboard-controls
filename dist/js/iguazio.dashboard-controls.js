...
(function () {
    ...
    NclVersionConfigurationVolumesController.$inject = ['$rootScope', '$timeout', '$i18next', 'i18next', 'lodash', 'DialogsService', 'ValidatingPatternsService'];
    ...
    function NclVersionConfigurationVolumesController($rootScope, $timeout, $i18next, i18next, lodash, DialogsService, ValidatingPatternsService) {
        var ctrl = this;
        var lng = i18next.language;
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('igz_controls/components/copy-to-clipboard/copy-to-clipboard.tpl.html',
    '<div class="igz-action-item" data-ng-click="$ctrl.copyToClipboard()" data-uib-tooltip="{{ \'common:TOOLTIP.COPY_TO_CLIPBOARD\' | i18next }}" data-tooltip-placement="{{ $ctrl.tooltipPlacement }}" data-tooltip-popup-delay="300" data-tooltip-append-to-body="true"><div class="action-icon ncl-icon-copy"></div></div>');
}]);
})();
