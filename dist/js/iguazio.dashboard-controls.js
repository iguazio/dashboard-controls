...
(function () {
    ...
    angular.module('nuclio.app').directive('igzMonacoEditor', ['$interval', function ($interval) {
...
(function () {
    ...
    angular.module('nuclio.app').component('nclMonaco', {
        bindings: {
            runtime: '<',
            functionSourceCode: '<',
